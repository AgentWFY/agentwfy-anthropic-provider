...
- **Model** — Select a Claude model (default: `claude-opus-4-8`). Available models: Opus 4.8, Opus 4.7, Sonnet 4.6, Opus 4.6, Sonnet 4.5, Opus 4.5, Sonnet 4, Opus 4, Haiku 4.5, Sonnet 3.7, Haiku 3.5.
- **Effort** — Controls reasoning depth and token spend on supported models (Opus 4.8, Opus 4.7, Opus 4.6, Sonnet 4.6, Opus 4.5). Values: `low`, `medium`, `high`, `xhigh` (Opus 4.7/4.8 only), `max`. Default: `xhigh` for Opus 4.8 / Opus 4.7, `high` otherwise.
